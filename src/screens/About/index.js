        ...
        <div className={styles.govTokenContainer}>
          ...
          <div className={styles.earnGovVoteContainer}>
            <div className={styles.earnGovVote}>
              ...
              The SpacePath Community powers the platform. That’s why users are rewarded weekly for their participation for voting, owning, buying, and selling NFTs.
              </div>
            </div>
            <div className={styles.earnGovVote}>
              <div className={styles.Icon}>
              ...
              <h1>Governace</h1>
              <div className={styles.earnGovVoteDiv}>
              As a decentralized platform, the SpacePath NFT Marketplace is run by the community. Anyone who owns SpacePath Token can vote in major decisions about the future of the platform.
              </div>
            </div>
            <div className={styles.earnGovVote}>
              <div className={styles.Icon}>
              ...
              <h1>Vote</h1>
              The SpacePath NFT Marketplace is unique in the fact that the community determines what gis minted onto the platform. Vote for your favorite work and get rewarded with token!
            </div>
          </div>
        </div>
